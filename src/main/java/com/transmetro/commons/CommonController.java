...
public class CommonController<E, S extends CommonSvc<E>, V extends CommonValidatorSvc<E>> {
    ...
    @GetMapping
    @ApiOperation(value = "Consulta el listado de objetos de transmetro")
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "Consulta un objeto especifico de transmetro")
    ...
    @ApiOperation(value = "Guarda la información de un objeto en transmetro")
    ...
    @ApiOperation(value = "Elimina la infirmación de un objeto en transmetro")
